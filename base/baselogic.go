...
type IGameLogic interface {
	...
	SavePlayerGameCoin(player IPlayerNode, gamecoin int64, writesource int)
	SavePlayerGoldBean(player IPlayerNode, goldbean int, writesource int)
	SavePlayerProp(player IPlayerNode, propinfo msg.UserPropChange, writesource int)
	SavePlayerGameEnd(player IPlayerNode, datachanged Userplaygamedata, writesource int)
